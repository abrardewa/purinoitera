...
export default function HelpScreen({ navigation }) {
  ...
  function getArticles(selectedPage) {
    axios
      .get(
        `https://docs.google.com/spreadsheets/u/1/d/e/2PACX-1vSVyqfgX8HUWq_t4kNoG3tSesRgsZRuDe-HoCavfwvIWxL2f9zJTrrtvcPtjgORaih81ZJx-7cjmjX2/pubhtml?gid=292382392&single=true`
      )
      .then((res) => {
